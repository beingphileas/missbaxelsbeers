...
export default function MultiLayerMap({ breweries, venues, posts, onSelectBrewery, focusLocation, hoveredPostId }: MultiLayerMapProps) {
  ...
  return (
    <div className="relative w-full h-full">
      ...
      {/* Layer toggles */}
      <div className="absolute bottom-10 right-3 md:top-3 md:bottom-auto md:right-3 z-[1000] bg-foreground/90 backdrop-blur-sm border border-white/10 p-2.5 flex flex-col gap-1.5 text-sm">
