    ...
    <Link to={`/beers/${beer.id}`}>
      ...
      >
        ...
        <div className="p-3.5 flex-1 flex flex-col">
          <h3 className="font-display text-sm md:text-base leading-tight mb-1 group-hover:text-accent transition-colors">{beer.name}</h3>
          {beer.brewedAt && (
            <p className="text-[10px] text-muted-foreground italic mb-2 flex items-center gap-1">
              <Handshake size={9} className="text-accent" />
              {beer.brewedAt}
            </p>
          )}
